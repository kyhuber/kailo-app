// src/components/topics/TopicModal.tsx
'use client';
...
export default function TopicModal({ isOpen, onClose, onTopicAdded, friends, initialData }: TopicModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={initialData ? "Edit Topic" : "Add a New Topic"}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1" htmlFor="topic-content">
            Topic Description <span className="text-rose-500">*</span>
          </label>
          <textarea
            id="topic-content"
            value={content}
            onChange={(e) => setContent(e.target.value)}
            placeholder="What do you want to talk about with your friend?"
